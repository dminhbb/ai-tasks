...
revoke all on function public.save_task_bundle(uuid, jsonb, jsonb, jsonb) from public, anon;
grant execute on function public.save_task_bundle(uuid, jsonb, jsonb, jsonb) to authenticated;
