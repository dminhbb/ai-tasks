module.exports=[18622,(e,t,a)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,a)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},14747,(e,t,a)=>{t.exports=e.x("path",()=>require("path"))},93695,(e,t,a)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},22734,(e,t,a)=>{t.exports=e.x("fs",()=>require("fs"))},85148,(e,t,a)=>{t.exports=e.x("better-sqlite3-90e2652d1716b047",()=>require("better-sqlite3-90e2652d1716b047"))},13547,47029,e=>{"use strict";var t=e.i(22734),a=e.i(14747),r=e.i(85148);let s=a.default.join(process.cwd(),"data"),o=a.default.join(s,"task-manager.db"),n=null;function i(){var e;let a,i;return n||(t.default.mkdirSync(s,{recursive:!0}),(n=new r.default(o)).pragma("foreign_keys = ON"),n.pragma("journal_mode = WAL"),(e=n).exec(`
  ...
  `).run(a,t,t,t).lastInsertRowid);return function(e,t){if(i().prepare("SELECT value FROM settings WHERE notebook_id = ? AND key = ?").get(e,"tags"))return;let a=i().prepare(`
    ...
    VALUES (?, ?, ?, ?)
  `);a.run(e,"tags",JSON.stringify(["Frontend","Backend","Design","Bug","Feature"]),t),a.run(e,"assistantIntents",JSON.stringify([]),t)}(r,t),d(r)}function l(e){return e.trim().replace(/\s+/g," ").slice(0,80)}e.s(["DB_FILE",0,o,"getDb",0,i],47029),e.s(["activateNotebook",0,function(e){if(!d(e))throw Error("Notebook not found");let t=new Date().toISOString();return i().prepare("UPDATE notebooks SET last_accessed_at = ?, updated_at = ? WHERE id = ?").run(t,t,e),d(e)},"createNotebook",0,u,"deleteNotebook",0,function(e){if(!d(e))throw Error("Notebook not found");let t=i();return t.transaction(()=>{t.prepare("DELETE FROM task_due_date_events WHERE notebook_id = ?").run(e),t.prepare("DELETE FROM task_status_events WHERE notebook_id = ?").run(e),t.prepare("DELETE FROM task_tags WHERE task_id IN (SELECT id FROM tasks WHERE notebook_id = ?)").run(e),t.prepare("DELETE FROM subtasks WHERE task_id IN (SELECT id FROM tasks WHERE notebook_id = ?)").run(e),t.prepare("DELETE FROM tasks WHERE notebook_id = ?").run(e),t.prepare("DELETE FROM settings WHERE notebook_id = ?").run(e),t.prepare("DELETE FROM notebooks WHERE id = ?").run(e)})(),T()||u("MAIN")},"getActiveNotebook",0,T,"listNotebooks",0,function(){return i().prepare("SELECT * FROM notebooks ORDER BY last_accessed_at DESC, name ASC").all().map(E)},"renameNotebook",0,function(e,t){if(!d(e))throw Error("Notebook not found");let a=l(t);if(!a)throw Error("Notebook name is required");let r=new Date().toISOString();return i().prepare("UPDATE notebooks SET name = ?, updated_at = ? WHERE id = ?").run(a,r,e),d(e)},"resolveNotebookId",0,function(e){let t=Number(e);return Number.isInteger(t)&&t>0&&d(t)?t:T().id}],13547)},89171,e=>{"use strict";var t=e.i(47909),a=e.i(74017),r=e.i(96250),s=e.i(59756),o=e.i(61916),n=e.i(74677),i=e.i(69741),E=e.i(16795),d=e.i(70996),T=e.i(95169),u=e.i(47587),l=e.i(66012),N=e.i(70101),p=e.i(26937),_=e.i(10372),R=e.i(93695);e.i(52474);var c=e.i(220),k=e.i(94028),L=e.i(13547);async function O(e,t){try{let{id:a}=await t.params,r=await e.json(),s=(0,L.renameNotebook)(Number(a),"string"==typeof r.name?r.name:"");return k.NextResponse.json({notebook:s,notebooks:(0,L.listNotebooks)()})}catch(e){return console.error("Failed to rename notebook:",e),k.NextResponse.json({error:e instanceof Error?e.message:"Failed to rename notebook"},{status:400})}}async function A(e,t){try{let{id:e}=await t.params,a=(0,L.deleteNotebook)(Number(e));return k.NextResponse.json({activeNotebook:a,notebooks:(0,L.listNotebooks)()})}catch(e){return console.error("Failed to delete notebook:",e),k.NextResponse.json({error:e instanceof Error?e.message:"Failed to delete notebook"},{status:400})}}e.s(["DELETE",0,A,"PATCH",0,O,"runtime",0,"nodejs"],20561);var I=e.i(20561);let b=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/notebooks/[id]/route",pathname:"/api/notebooks/[id]",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/notebooks/[id]/route.ts",nextConfigOutput:"standalone",userland:I,...{}}),{workAsyncStorage:S,workUnitAsyncStorage:g,serverHooks:C}=b;async function x(e,t,r){r.requestMeta&&(0,s.setRequestMeta)(e,r.requestMeta),b.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let k="/api/notebooks/[id]/route";k=k.replace(/\/index$/,"")||"/";let L=await b.prepare(e,t,{srcPage:k,multiZoneDraftMode:!1});if(!L)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:O,deploymentId:A,params:I,nextConfig:S,parsedUrl:g,isDraftMode:C,prerenderManifest:x,routerServerContext:m,isOnDemandRevalidate:f,revalidateOnlyGenerated:v,resolvedPathname:D,clientReferenceManifest:U,serverActionsManifest:h}=L,F=(0,i.normalizeAppPath)(k),X=!!(x.dynamicRoutes[F]||x.routes[D]),y=async()=>((null==m?void 0:m.render404)?await m.render404(e,t,g,!1):t.end("This page could not be found"),null);if(X&&!C){let e=!!x.routes[D],t=x.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(S.adapterPath)return await y();throw new R.NoFallbackError}}let M=null;!X||b.isDev||C||(M="/index"===(M=D)?"/":M);let w=!0===b.isDev||!X,P=X&&!w;h&&U&&(0,n.setManifestsSingleton)({page:k,clientReferenceManifest:U,serverActionsManifest:h});let G=e.method||"GET",H=(0,o.getTracer)(),q=H.getActiveScopeSpan(),B=!!(null==m?void 0:m.isWrappedByNextServer),j=!!(0,s.getRequestMeta)(e,"minimalMode"),Y=(0,s.getRequestMeta)(e,"incrementalCache")||await b.getIncrementalCache(e,S,x,j);null==Y||Y.resetRequestCache(),globalThis.__incrementalCache=Y;let K={params:I,previewProps:x.preview,renderOpts:{experimental:{authInterrupts:!!S.experimental.authInterrupts},cacheComponents:!!S.cacheComponents,supportsDynamicResponse:w,incrementalCache:Y,cacheLifeProfiles:S.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r,s)=>b.onRequestError(e,t,r,s,m)},sharedContext:{buildId:O,deploymentId:A}},W=new E.NodeNextRequest(e),$=new E.NodeNextResponse(t),V=d.NextRequestAdapter.fromNodeNextRequest(W,(0,d.signalFromNodeResponse)(t));try{let s,n=async e=>b.handle(V,K).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=H.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==T.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${G} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t),s&&s!==e&&(s.setAttribute("http.route",r),s.updateName(t))}else e.updateName(`${G} ${k}`)}),i=async s=>{var o,i;let E=async({previousCacheEntry:a})=>{try{if(!j&&f&&v&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let o=await n(s);e.fetchMetrics=K.renderOpts.fetchMetrics;let i=K.renderOpts.pendingWaitUntil;i&&r.waitUntil&&(r.waitUntil(i),i=void 0);let E=K.renderOpts.collectedTags;if(!X)return await (0,l.sendResponse)(W,$,o,K.renderOpts.pendingWaitUntil),null;{let e=await o.blob(),t=(0,N.toNodeOutgoingHttpHeaders)(o.headers);E&&(t[_.NEXT_CACHE_TAGS_HEADER]=E),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==K.renderOpts.collectedRevalidate&&!(K.renderOpts.collectedRevalidate>=_.INFINITE_CACHE)&&K.renderOpts.collectedRevalidate,r=void 0===K.renderOpts.collectedExpire||K.renderOpts.collectedExpire>=_.INFINITE_CACHE?void 0:K.renderOpts.collectedExpire;return{value:{kind:c.CachedRouteKind.APP_ROUTE,status:o.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await b.onRequestError(e,t,{routerKind:"App Router",routePath:k,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:f})},!1,m),t}},d=await b.handleResponse({req:e,nextConfig:S,cacheKey:M,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:x,isRoutePPREnabled:!1,isOnDemandRevalidate:f,revalidateOnlyGenerated:v,responseGenerator:E,waitUntil:r.waitUntil,isMinimalMode:j});if(!X)return null;if((null==d||null==(o=d.value)?void 0:o.kind)!==c.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==d||null==(i=d.value)?void 0:i.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});j||t.setHeader("x-nextjs-cache",f?"REVALIDATED":d.isMiss?"MISS":d.isStale?"STALE":"HIT"),C&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let T=(0,N.fromNodeOutgoingHttpHeaders)(d.value.headers);return j&&X||T.delete(_.NEXT_CACHE_TAGS_HEADER),!d.cacheControl||t.getHeader("Cache-Control")||T.get("Cache-Control")||T.set("Cache-Control",(0,p.getCacheControlHeader)(d.cacheControl)),await (0,l.sendResponse)(W,$,new Response(d.value.body,{headers:T,status:d.value.status||200})),null};B&&q?await i(q):(s=H.getActiveScopeSpan(),await H.withPropagatedContext(e.headers,()=>H.trace(T.BaseServerSpan.handleRequest,{spanName:`${G} ${k}`,kind:o.SpanKind.SERVER,attributes:{"http.method":G,"http.target":e.url}},i),void 0,!B))}catch(t){if(t instanceof R.NoFallbackError||await b.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,u.getRevalidateReason)({isStaticGeneration:P,isOnDemandRevalidate:f})},!1,m),X)throw t;return await (0,l.sendResponse)(W,$,new Response(null,{status:500})),null}}e.s(["handler",0,x,"patchFetch",0,function(){return(0,r.patchFetch)({workAsyncStorage:S,workUnitAsyncStorage:g})},"routeModule",0,b,"serverHooks",0,C,"workAsyncStorage",0,S,"workUnitAsyncStorage",0,g],89171)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__0~903o2._.js.map